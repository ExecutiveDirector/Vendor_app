...
class _VendorOutletsScreenState extends State<VendorOutletsScreen> {
  ...
  Future<void> _loadOutlets() async {
    try {
      ...
      // ✅ FIX: /vendor/outlets → /vendors/outlets
  ...
  Future<void> _deleteOutlet(int outletId, String outletName) async {
    ...
    try {
      // ✅ FIX: /vendor/outlets/$outletId → /vendors/outlets/$outletId
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildInfoRow(Icons.map_outlined, '${outlet['county']} County'),
                if (outlet['contact_phone'] != null) ...[
                  const SizedBox(height: 8),
                  _buildInfoRow(Icons.phone_outlined, outlet['contact_phone']),
                ],
